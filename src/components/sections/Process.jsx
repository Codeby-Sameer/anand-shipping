          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <motion.div variants={fadeUp} className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                Founded on the principle of <span className="font-semibold text-amber-600">"Excellence in Every Delivery"</span>, 
            ...
            {[
              {
                ...
                description: "Multi-layered security protocols including tamper-evident packaging and 24/7 monitoring."
              },
              {
                icon: "fas fa-gem",
                title: "Premium Quality",
                description: "Elite-grade packaging materials and white-glove handling for all shipments."
              },
              {
                icon: "fas fa-clock",
                title: "Time Precision",
                description: "Guaranteed delivery timeframes with real-time tracking and proactive updates."
              }
            ].map((value, index) => (
              <motion.div
                key={index}
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-amber-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
