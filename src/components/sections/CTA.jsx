            ...
            <motion.div variants={containerVariants}
              ...
              {TESTIMONIALS.map((t, index) => (
                <motion.div key={index}
                  ...
                  whileHover={{ y: -6 }}
                  className="relative bg-white rounded-2xl border border-gray-200 p-8 text-center shadow-md hover:shadow-xl transition">
      ...
      <section className="py-16 bg-blue-800 text-white"
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/contact"
              className="px-8 py-3 bg-amber-500 border-2 border-amber-500 text-gray-900 font-bold rounded-full hover:bg-amber-600 hover:border-amber-600 transition flex items-center justify-center">
              <i className="fas fa-calendar-plus mr-2" />
              Schedule Pickup
            </Link>

            <Link to="/contact"
              className="px-8 py-3 bg-transparent border-2 border-white text-white font-bold rounded-full hover:bg-white hover:text-blue-800 transition flex items-center justify-center">
